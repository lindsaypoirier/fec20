...
> Note that this is an updated version of the `fec16` package, originally created by the [Baumer Lab](https://github.com/baumer-lab/fec16).
...
## Contributors
 ...
 - [Lindsay Poirier](https://github.com/lindsaypoirier) updated the code for 2020.
