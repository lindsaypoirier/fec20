...
`house_results`: the results of the 2016 general presidential election
...
Using the `house_results` dataset, we can also see what actually happened in the 2016 elections.
